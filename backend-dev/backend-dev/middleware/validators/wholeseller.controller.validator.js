	...
	switch (method) {
		case 'createWholeseller': {
			return [
				...
				body('wholesellerAdmin')
					.notEmpty()
					.withMessage('Wholeseller Admin is required')
					.isObject()
					.withMessage('Wholeseller Admin must be an object'),
				body('wholesellerAdmin.firstName')
					.notEmpty()
				...
				body('wholesellerAdmin.lastName')
					.notEmpty()
